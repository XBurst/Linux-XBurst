	...
	if (intst & JZ4780_I2C_INTST_TXEMP) {
		if (i2c->is_write == 0) {
			...
			while ((i2c_sta & JZ4780_I2C_STA_TFNF) &&
				...
				if ((!i2c->stop_hold) && (i2c->cdata->version >= ID_X1000))
...
static const struct ingenic_i2c_config jz4780_i2c_config = {
	...
	.fifosize = 16,
	.tx_level = 8, //tx_level = fifo_len / 2
	.rx_level = 7, //rx_level = fifo_len / 2 - 1
};
...
static const struct ingenic_i2c_config x1000_i2c_config = {
	...
	.fifosize = 64,
	.tx_level = 32, //tx_level = fifo_len / 2
	.rx_level = 31, //rx_level = fifo_len / 2 - 1
};
...
static int jz4780_i2c_probe(struct platform_device *pdev)
{
	...
	match = of_match_device(jz4780_i2c_of_matches, &pdev->dev);
	if (!match) {
