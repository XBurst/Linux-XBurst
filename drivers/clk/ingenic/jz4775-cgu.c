...
static const struct ingenic_cgu_clk_info jz4775_cgu_clocks[] = {
	...
	[JZ4775_CLK_UHCPHY] = {
		...
		.parents = { -1, -1, JZ4775_CLK_UHC, -1 },
		.custom = { &jz4775_uhc_phy_ops },
	},

	[JZ4775_CLK_OTGPHY] = {
		"otg_phy", CGU_CLK_CUSTOM,
		.parents = { -1, -1, JZ4775_CLK_EXCLK, -1 },
	...
	[JZ4775_CLK_AHB2] = {
		"ahb2", CGU_CLK_DIV,
		.parents = { JZ4775_CLK_AHB2PMUX, -1, -1, -1 },
	...
	[JZ4775_CLK_VPU] = {
		...
		.parents = { JZ4775_CLK_SCLKA, JZ4775_CLK_MPLL, -1, -1 },
	...
	[JZ4775_CLK_MSC0] = {
		...
		.parents = { JZ4775_CLK_MSCMUX, -1, -1, -1 },
	...
	[JZ4775_CLK_RTC] = {
		...
		.parents = { JZ4775_CLK_EXCLK_DIV512, JZ4775_CLK_RTCLK, -1, -1 },
	...
	[JZ4775_CLK_NEMC] = {
		"nemc", CGU_CLK_GATE,
		.parents = { JZ4775_CLK_AHB2, -1, -1, -1 },
		.gate = { CGU_REG_CLKGR, 0 },
	},

	[JZ4775_CLK_I2C0] = {
		"i2c0", CGU_CLK_GATE,
		.parents = { JZ4775_CLK_PCLK, -1, -1, -1 },
